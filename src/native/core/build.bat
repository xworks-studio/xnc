...
cl /nologo /utf-8 /W3 /MT /std:c++17 /EHsc /MP %XNC_VERSION_DEFINE% xnc-core.cpp service.cpp pipe_server.cpp wts_monitor.cpp token_manager.cpp spawn.cpp secret_file.cpp selftest.cpp ..\common\frame.cpp ..\common\handshake.cpp /Fe:..\..\..\bin\xnc-core.exe /Fo:..\..\..\bin\ /link bcrypt.lib advapi32.lib wtsapi32.lib user32.lib userenv.lib
