...
#
#   t,cursorX,cursorY,keyA,keyCtrl,keyShift
#
...
try {
  $writer.WriteLine('t,cursorX,cursorY,keyA,keyCtrl,keyShift')
  ...
  while ([DateTimeOffset]::UtcNow -lt $deadline) {
    ...
    $row = '{0},{1},{2},{3},{4},{5}' -f $iterStart.ToUnixTimeMilliseconds(), $p.X, $p.Y, (KeyBit 0x41), (KeyBit 0x11), (KeyBit 0x10)
